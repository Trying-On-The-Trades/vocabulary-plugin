...
function update_deck($deck_id, $deck_name, $deck_image, $deck_number_of_words, $deck_type){
    global $wpdb;
    $deck_table_name = get_decks_table_name();
...
function create_deck($deck_name, $deck_image, $deck_number_of_words, $deck_type){
    global $wpdb;
    $deck_table_name = get_decks_table_name();
