...
register_activation_hook( __FILE__, 'wordpla_install');
...
require_once("admin/new_hatplagame.php");
require_once("admin/edit_hatplagame.php");
require_once("admin/hatplagames.php");
require_once("admin/view_hatplagame.php");
