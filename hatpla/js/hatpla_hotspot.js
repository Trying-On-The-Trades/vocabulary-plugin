...
rightAnswer.setAttribute("src", "../hatpla/images/right.png");
rightAnswer.setAttribute("alt", "Right!");

var gameOver = document.createElement("img");
gameOver.setAttribute("src", "../hatpla/images/gameOver.png");
