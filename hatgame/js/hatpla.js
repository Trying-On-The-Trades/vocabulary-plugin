...
error1.setAttribute("src", "../wp-content/plugins/vocabulary-plugin/hatgame/images/1error.png");
error1.setAttribute("alt", "No Image");   

var error2 = document.createElement("img");
error2.setAttribute("src", "../wp-content/plugins/vocabulary-plugin/hatgame/images/2error.png");
error2.setAttribute("alt", "No Image");

var error3 = document.createElement("img");
error3.setAttribute("src", "../wp-content/plugins/vocabulary-plugin/hatgame/images/3error.png");
error3.setAttribute("alt", "No Image");

var error4 = document.createElement("img");
error4.setAttribute("src", "../wp-content/plugins/vocabulary-plugin/hatgame/images/4error.png");
error4.setAttribute("alt", "No Image");

var error5 = document.createElement("img");
error5.setAttribute("src", "../wp-content/plugins/vocabulary-plugin/hatgame/images/5error.png");
error5.setAttribute("alt", "No Image");

var error6 = document.createElement("img");
error6.setAttribute("src", "../wp-content/plugins/vocabulary-plugin/hatgame/images/6error.png");
error6.setAttribute("alt", "No Image");

var error7 = document.createElement("img");
error7.setAttribute("src", "../wp-content/plugins/vocabulary-plugin/hatgame/images/7error.png");
...
rightAnswer.setAttribute("src", "../wp-content/plugins/vocabulary-plugin/hatgame/images/right.png");
rightAnswer.setAttribute("alt", "Right!");

var gameOver = document.createElement("img");
gameOver.setAttribute("src", "../wp-content/plugins/vocabulary-plugin/hatgame/images/gameOver.png");
